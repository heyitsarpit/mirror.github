...
export type StarredRepositoriesByLoginQuery = {
  __typename?: 'Query'
  user?:
    | {
        __typename?: 'User'
...
export function useViewerLoginQuery(
  options: Omit<Urql.UseQueryArgs<ViewerLoginQueryVariables>, 'query'> = {}
) {
  return Urql.useQuery<ViewerLoginQuery>({ query: ViewerLoginDocument, ...options })
}
export const UserByLoginDocument = gql`
...
export function useUserByLoginQuery(
  options: Omit<Urql.UseQueryArgs<UserByLoginQueryVariables>, 'query'> = {}
) {
  return Urql.useQuery<UserByLoginQuery>({ query: UserByLoginDocument, ...options })
}
export const StarredRepositoriesByLoginDocument = gql`
...
export function useStarredRepositoriesByLoginQuery(
  options: Omit<Urql.UseQueryArgs<StarredRepositoriesByLoginQueryVariables>, 'query'> = {}
) {
  return Urql.useQuery<StarredRepositoriesByLoginQuery>({
    query: StarredRepositoriesByLoginDocument,
    ...options
  })
}
